...
export default function AddLeadPage() {
  ...
  const [data, setData] = useState({
    ...
    location: "",
    description: "",
    lead_generated_by: "Admin"   // ✅ REQUIRED
  });
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <form onSubmit={submitLead} className="bg-white p-6 rounded shadow space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <input className="border p-2 rounded" name="lead_assigned_to" placeholder="Lead Assigned To" onChange={handleChange} />
          <input className="border p-2 rounded" name="lead_status" placeholder="Lead Status" onChange={handleChange} />
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <input className="border p-2 rounded" name="country" value={data.country} onChange={handleChange} />
